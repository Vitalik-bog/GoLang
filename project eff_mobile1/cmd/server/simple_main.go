...
func main() {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprintf(w, `<h1>Subscription Service</h1>
        <p>API endpoints:</p>
        <ul>
            <li>GET /health</li>
            <li>GET /api/v1/subscriptions</li>
            <li>POST /api/v1/subscriptions</li>
            <li>GET /api/v1/subscriptions/total-cost</li>
        </ul>`)
	})
	...
	http.HandleFunc("/api/v1/subscriptions", func(w http.ResponseWriter, r *http.Request) {
		...
		case "POST":
			...
			var id int
			err := db.QueryRow(
				"INSERT INTO subscriptions (service_name, price, user_id, start_date) VALUES ($1, $2, $3, $4) RETURNING id",
